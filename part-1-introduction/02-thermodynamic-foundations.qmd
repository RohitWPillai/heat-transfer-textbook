...
Recall from Chapter 1 the distinction between heat transfer rate ($q$, in watts), heat flux ($q''$, in W/m²), and the prime notation. Here we add one more quantity: **volumetric heat generation**.
