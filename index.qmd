...
One more thing: the book is open-source. I remember being an undergraduate and spending £80 on a textbook I opened three times. That left a mark. So this one is free, the code is on [GitHub](https://github.com/RohitWPillai/heat-transfer-textbook), and you can read it in your browser, fork it, or download the whole thing. If you find an error or think an explanation could be clearer, you can open a pull request. I mean that.
...
Found an error? Have a suggestion? Please [open an issue](https://github.com/RohitWPillai/heat-transfer-textbook/issues) on GitHub.
